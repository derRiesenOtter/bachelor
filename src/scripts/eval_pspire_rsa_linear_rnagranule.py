...
from src.modules.cnn_2l_rsa_linear import CNN2L
...
state_dict = torch.load(
    "./data/processed_data/model_run_cnn2l_ppmclab_pspire_rsa_linear"
)
model.load_state_dict(state_dict)
model.to(device)
model.eval()

model_name = "eval_pspire_rsa_linear_mlo_rnagranule"
