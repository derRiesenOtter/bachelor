...
from src.modules.cnn_2l_trans_rsa_weight_bn_ptm import CNN2LWithTransformer
...
val_loader = DataLoader(val_data_set, batch_size=16, shuffle=False)

# get the number of categories
num_categories = df["mapped_seq"].explode().nunique() + 1

# Create the model
model = CNN2LWithTransformer(
