...
with open("./data/intermediate_data/pspire_PhaSepDB_MLO_rsa.pkl", "rb") as f:
    df_mlo = pickle.load(f)

# df_mlo = df_mlo.loc[df_mlo["Type"] == "ID-PSP"]

model_name = "eval_pspire_mlo_rsa_bn_phasep_idr"
...
state_dict = torch.load(
    "./data/processed_data/model_run_cnn2l_pspire_rsa_weight_bn_idr"
)
