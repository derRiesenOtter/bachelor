...
from src.modules.cnn_2l_ptm import CNN2L
from src.modules.get_ptm import add_ptm
from src.modules.sequence_dataset_ptm import SequenceDataSet
from src.modules.train_eval_ptm import run_train_eval
...
train_data_set = SequenceDataSet(train_df, "mapped_seq", "ptm_profile", "ps_label")
train_loader = DataLoader(train_data_set, batch_size=32, shuffle=True)
val_data_set = SequenceDataSet(val_df, "mapped_seq", "ptm_profile", "ps_label")
