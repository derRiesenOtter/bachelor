...
with open("./data/intermediate_data/pspire_G3BP1 proximity labeling.pkl", "rb") as f:
...
state_dict = torch.load("./data/processed_data/model_run_cnn2l_ppmclab_pspire")
model.load_state_dict(state_dict)
model.to(device)
model.eval()

model_name = "eval_pspire_mlo_g3bp1"
