...
ppmclab_df = ppmclab_df.loc[
    (ppmclab_df["idr_protein"] == 0) | (ppmclab_df["ps_label"] == 0)
]
pspire_df = pspire_df.loc[
    (pspire_df["idr_protein"] == 0) | (pspire_df["ps_label"] == 0)
]
...
ppmclab_df = ppmclab_df.loc[~ppmclab_df["id"].isin(pspire_df["id"])]
